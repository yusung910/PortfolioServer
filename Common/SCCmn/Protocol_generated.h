...
enum EErrorMsg {
  ...
  EF_LOGIN_ERROR_OUTER_PLATFORM = 103,
...
inline const EErrorMsg (&EnumValuesEErrorMsg())[13] {
...
inline const char *EnumNameEErrorMsg(EErrorMsg e) {
  switch (e) {
    ...
    case EF_LOGIN_ERROR_OUTER_PLATFORM: return "EF_LOGIN_ERROR_OUTER_PLATFORM";
