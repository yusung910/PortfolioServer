...
//dztall 8 -> 40
static const int DT_MAX_TOUCHED_TILES = 40;
...
public:
	...
	// Cylinder obstacle.
	dtStatus addObstacle(long long i64CustomUID, const float* pos, const float radius, const float height, dtObstacleRef* result);

	// Aabb obstacle.
	dtStatus addBoxObstacle(long long i64CustomUID, const float* bmin, const float* bmax, dtObstacleRef* result);

	// Box obstacle: can be rotated in Y.
	dtStatus addBoxObstacle(long long i64CustomUID, const float* center, const float* halfExtents, const float yRadians, dtObstacleRef* result);
...
public:
	...
	static const int MAX_REQUESTS = 256;	// dztall 64 -> 256
	ObstacleRequest m_reqs[MAX_REQUESTS];
	int m_nreqs;

	static const int MAX_UPDATE = 256;	// dztall 64 -> 256
