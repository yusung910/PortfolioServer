...
private:
    ...
    std::wregex m_oAccountIDPattern = std::wregex(REGEX_PATTERN_ASCII_ACCOUNT_UKEY);
...
public:
    ...
    bool IsValidAccountID(const std::wstring& _str, const size_t& _min, const size_t& _max);
